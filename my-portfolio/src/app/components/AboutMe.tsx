            ...
            <div className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-sm sm:text-base text-white/70 leading-relaxed font-light">
                  I'm a passionate Software Engineer Intern based in Sri Lanka, driven by the endless possibilities 
                ...
                <p className="text-sm sm:text-base text-white/70 leading-relaxed font-light">
                  When I'm not coding, you'll find me exploring the latest AI innovations, contributing to 
