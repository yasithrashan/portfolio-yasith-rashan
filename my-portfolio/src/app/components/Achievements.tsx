  ...
  return (
    <div className="bg-white text-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 sm:px-10 md:px-16 lg:px-24 py-24">
        <div className="max-w-full sm:max-w-4xl w-full mx-auto text-center">
          ...
          <div className="mb-16">
            ...
            <p className="text-sm sm:text-base text-gray-600 leading-relaxed font-light max-w-xl mx-auto">
          ...
          <div className="mb-16">
            <h3 className="text-xl sm:text-2xl font-medium mb-8 text-center">Key Milestones</h3>
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6">
                {achievements.map((achievement) => (
                  <div key={achievement.id} className="flex flex-col sm:flex-row gap-6 group text-left">
                    {/* Date Column */}
                    ...
                    <div className="flex-1 border-l border-gray-200 pl-6 group-hover:border-gray-300 transition-colors">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 space-y-2">
                          <h4 className="font-medium text-gray-900 group-hover:text-gray-700 transition-colors text-sm sm:text-base">
                            {achievement.title}
                          </h4>
